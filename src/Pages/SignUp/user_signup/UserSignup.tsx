...
const UserSignup = () => {
  ...
  const onSubmit = (data: UserSignupForm) => {
    const { firstname, lastname, contactnumber, email, addressline1, addressline2, addressline3, username, password, confirmpassword } = data;
    usersignup(firstname, lastname, contactnumber, email, addressline1, addressline2, addressline3, username, password, confirmpassword).then(
      (response) => {
